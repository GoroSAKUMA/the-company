<?php
  # We need to start the session in order to use the session variables
  session_start();
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                ?>
                  <a href="edit-user.php" class="btn btn-outline-warning" tittle="Edit">
                    <i class="fa-regular fa-pen-to-square"></i>
                  </a>
                  <a href="delete-user.php" class="btn btn-outline-danger" tittle="Delete">
