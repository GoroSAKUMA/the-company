<?php
  ...
  class User extends Database{
    public function store($request){
      ...
      # PASSWORD_DEFAULT - The algorithm use to hashed the password
      ...
      if ($this->conn->query($sql)){
        ...
        die("Error in creating an user. " . $this->conn->error);
      }
    }
    ...
    public function logout(){
      ...
      session_unset(); //unset the session variables we have set during login
    ...
    public function update($request, $files){
      ...
      if($this->conn->query($sql)){
        ...
        #check if there is an uploaded photo, save to Db and save the files into the images folder
        if($photo){
        ...
        exit;
          ...
          die("Error in uploading the user." . $this->conn->error);
      }
    }
